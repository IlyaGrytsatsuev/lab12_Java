...
public class Server {
    ...
    private HashMap<String, ArrayList<String>> blacklist = new HashMap<>();
    ...
    public void start() throws Exception{
        ...
        while(true){
                ...
                ToClientSendThread ClientThread = new ToClientSendThread(serverToClientSocket, ClientMap, blacklist);
                ClientThread.start();
        }
    }
}
